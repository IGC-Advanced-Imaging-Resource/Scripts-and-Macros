//This macro will measure distances between selected FISH probe pairs/triplets on all OPEN images (instead of all images in a specified folder)
...
//Your choice is then applied to all the open images
